...
public class MessageAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		try {
			String dateString = DateFormat.format("yyyy-MM-dd HH:mm", message.getTime()).toString();
		...
		ImageLoader.getInstance().displayImage(
				"https://img.youjiaopingtai.com/"+message.getToUserAvatar(),
				viewHolder.userAvatarImageView,getOptions());
