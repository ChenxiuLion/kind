			...
			messageEditText.addTextChangedListener(new TextWatcher() {
				...
				public void onTextChanged(CharSequence s, int start, int before, int count) {
					if(s != null && !"".equals(s.toString().trim())){
						...
						sendButton.setBackgroundResource(R.drawable.shape_chat_newlv);
						...
						//}
						sendButton.setBackgroundResource(R.drawable.shape_chat_new);
						sendButton.setTextColor(Color.parseColor("#424242"));
					}
				}
