 ...
 *
 */
public class AlbumAty extends CamerActivity implements View.OnClickListener,AlbumGridView.OnCheckedChangeListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mAlbumView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				String path = arg1.getTag().toString();
	...
	public void onClick(View v) {
		...
		int i = v.getId();
		if (i == R.id.header_bar_enter_selection) {
			enterEdit();

		} else if (i == R.id.header_bar_leave_selection) {
			leaveEdit();
		...
		} else if (i == R.id.header_bar_back) {
