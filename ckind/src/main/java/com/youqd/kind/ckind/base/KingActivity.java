...
public abstract class KingActivity extends ActivitySupport implements View.OnClickListener{
	...
	public void setBaby(LoginBean.AllBaByBean bean){
		UserManage.getInstance().setBaby(bean);
	}
	...
	public LoginBean.AllBaByBean getBaby(){
		return UserManage.getInstance().getBaby();
	}
