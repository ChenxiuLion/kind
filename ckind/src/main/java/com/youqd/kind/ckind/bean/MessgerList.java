...
public class MessgerList {
    ...
    public List<Gardener> getMessgers(){
        ...
        for (ResultDataBean bean : getResultData()) {
            ...
            if (mGardenerMap.get(bean.getGardenerID()) == null) {
                gardener = new Gardener();
                gardener.setGardenerID(bean.getGardenerID());
                if(bean.isMessger()) {
                    gardener.setGardenerAccount(bean.getGardenerAccount());
                    gardener.setGardenerName(bean.getGardenerName());
                    gardener.setGardenerPhoto(bean.getGardenerPhoto());
                } else{
                ...
                mGardenerMap.put(bean.getGardenerID(), gardener);
            }
            gardener = mGardenerMap.get(bean.getGardenerID());
