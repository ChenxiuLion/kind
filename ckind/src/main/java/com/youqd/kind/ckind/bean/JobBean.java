...
public class JobBean implements Serializable {
    ...
    private String okLaoshiName;

    public String getOkLaoshiDate() {
        return okLaoshiDate;
    }

    public void setOkLaoshiDate(String okLaoshiDate) {
        this.okLaoshiDate = okLaoshiDate;
    }

    public String getOkLaoshiName() {
        return okLaoshiName;
    }

    public void setOkLaoshiName(String okLaoshiName) {
        this.okLaoshiName = okLaoshiName;
    }

    private String okLaoshiDate;
