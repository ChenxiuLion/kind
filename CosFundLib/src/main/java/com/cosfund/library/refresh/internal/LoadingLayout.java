...
public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout {
	...
	public LoadingLayout(Context context, final PullToRefreshBase.Mode mode, final PullToRefreshBase.Orientation scrollDirection, TypedArray attrs) {
		...
		mImageView = (ImageView) mInnerLayout.findViewById(R.id.loding_anim);
		...
		switch (mode) {
			case PULL_FROM_END:
				...
				mImageView.setImageResource(R.drawable.icon_defult_loding_12);
				// Load in labels
	...
	public final void refreshing() {
		...
		mImageView.setImageResource(R.drawable.loding_image);
	...
	private void setSubHeaderText(CharSequence label) {
		if (null != mSubHeaderText) {
			if (TextUtils.isEmpty(label)) {
				...
				mSubHeaderText.setText("上次刷新："+label);
