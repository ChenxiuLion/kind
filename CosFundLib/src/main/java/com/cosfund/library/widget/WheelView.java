...
public class WheelView extends View {
    ...
    private void drawLine(Canvas canvas) {
        ...
        canvas.drawLine(firstLineAndSecondLineSpace, controlHeight / 2 - unitHeight / 2 + 2, controlWidth - firstLineAndSecondLineSpace, controlHeight / 2 - unitHeight / 2 + 2, bottomLinePaint);
        canvas.drawLine(firstLineAndSecondLineSpace, controlHeight / 2 + unitHeight / 2 - 2, controlWidth - firstLineAndSecondLineSpace, controlHeight / 2 + unitHeight / 2 - 2, bottomLinePaint);
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        bottomLineColor = attribute.getColor(R.styleable.WheelView_bottomLineColor, 0xffDADADA);
