...
public class ListImageDirPopupWindow extends PopupWindow 
{
	...
	private class ListDirAdapter extends ArrayAdapter<FolderBean>
	{
		...
		public View getView(int position, View convertView, ViewGroup parent) 
		{
			...
			{
				holder=new ViewHold();
				convertView=mInflater.inflate(R.layout.popup_main, null);
			...
			//重置
			holder.mImg.setImageResource(R.drawable.wl_chat_btn_sendimage);
			
			ImageDown.getInstance(3, ImageDown.Type.LIFO).loadImage(bean.getFirstImagPath(),holder.mImg);
