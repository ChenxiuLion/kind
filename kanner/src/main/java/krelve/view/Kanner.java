...
//            iv.setBackgroundResource(R.drawable.loading);
    ...
    private OnPageImageLiseten mOnPageImageLiseten;


    public void setOnPageImageLiseten(OnPageImageLiseten mOnPageImageLiseten) {
        this.mOnPageImageLiseten = mOnPageImageLiseten;
    }

    public interface OnPageImageLiseten{
        void onPageImage(int position);
    }
...
//            iv.setBackgroundResource(R.mipmap.loading);
            if (i == 0) {
                mImageLoader.displayImage("http://122.114.98.206:8080/Resources/"+imagesUrl[count - 1], iv, options);
            } else if (i == count + 1) {
                mImageLoader.displayImage("http://122.114.98.206:8080/Resources/"+imagesUrl[0], iv, options);
            } else {
                mImageLoader.displayImage("http://122.114.98.206:8080/Resources/"+imagesUrl[i - 1], iv, options);
            }
            iv.setTag(i);
            iv.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    if(mOnPageImageLiseten!=null){
                        int a = (int) v.getTag();
                        if(System.currentTimeMillis()-topTime>1000) {
                            mOnPageImageLiseten.onPageImage(a);
