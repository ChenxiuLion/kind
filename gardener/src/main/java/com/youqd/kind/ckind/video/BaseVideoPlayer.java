...
import com.youqd.kind.ckind.MyVideoPlayer;
...
//            duration = currentMediaPlayer.getDuration();
    ...
    public void fixPLViews(){
        ...
        LayoutParams params = (LayoutParams) this.surfaceView.getLayoutParams();
        FrameLayout.LayoutParams parentParam = (FrameLayout.LayoutParams) this.parentView.getLayoutParams();
        if(isLoaded){
            try {
