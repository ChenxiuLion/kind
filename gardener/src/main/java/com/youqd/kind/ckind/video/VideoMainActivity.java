package com.youqd.kind.ckind.video;
...
import com.youqd.kind.ckind.video.camera.CameraPreview;
...
//        mMediaRecorder.setVideoSize(mVideoSize.width, mVideoSize.height);
    ...
    private static class RecordButtonTouchListener implements View.OnTouchListener {
        ...
        private WeakReference<VideoMainActivity> mMainActivityWeakReference;

        private boolean isCancelRecord = false;
        private boolean jumpToNew = true;

        public RecordButtonTouchListener(VideoMainActivity mainActivity) {
            mMainActivityWeakReference = new WeakReference<VideoMainActivity>(mainActivity);
        }

        @Override
        public boolean onTouch(View v, MotionEvent event) {
            final VideoMainActivity mainActivity = mMainActivityWeakReference.get();
