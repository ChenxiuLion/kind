...
public class Contact2Activity extends KingActivity implements AdapterView.OnItemClickListener{
    ...
    protected void initViews() {
        ...
        ((TextView)findViewById(R.id.top_title)).setText("校园联系录");
        ...
        mEditTv.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                HttpTool.getInstance().doGardener(s.toString(),getUser().getKindergartenID()+"",getUser().getClassID()+"",
        ...
        HttpTool.getInstance().doGardener("",getUser().getKindergartenID()+"",getUser().getClassID()+"",
                new KingCallback<GardenerList>(GardenerList.class) {
                    @Override
                    public void onSucceed(GardenerList data) {
