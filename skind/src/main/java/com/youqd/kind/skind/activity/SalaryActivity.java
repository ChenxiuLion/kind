...
import com.youqd.kind.skind.fragment.SalaryFragment;
...
public class SalaryActivity extends FragmentActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView)findViewById(R.id.top_title)).setText("宝贝考勤");
