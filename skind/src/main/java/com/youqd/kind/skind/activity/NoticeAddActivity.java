...
public class NoticeAddActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView)findViewById(R.id.top_title)).setText("添加通知");
        ...
        noScrollgridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position,long arg3) {
                ...
                if(info.isAddButton()){
                    ...
                    openCameraSDKPhotoPick(NoticeAddActivity.this, list);
                }
                else{
                    openCameraSDKImagePreview(NoticeAddActivity.this,pic_list.get(position).getSource_image(),position);
                }
            }
        });
    }
