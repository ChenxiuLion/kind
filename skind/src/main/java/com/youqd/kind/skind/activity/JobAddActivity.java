...
public class JobAddActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView)findViewById(R.id.top_title)).setText("添加班级作业");
        ...
        noScrollgridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position,long arg3) {
                ...
                if(info.isAddButton()){
                    ...
                    openCameraSDKPhotoPick(JobAddActivity.this, list);
                }
                else{
                    openCameraSDKImagePreview(JobAddActivity.this,pic_list.get(position).getSource_image(),position);
                }
            }
        });
    }
