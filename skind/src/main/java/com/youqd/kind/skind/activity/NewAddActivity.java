...
public class NewAddActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView)findViewById(R.id.top_title)).setText("添加新闻");
        ...
        noScrollgridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position,long arg3) {
                ...
                if(info.isAddButton()){
                    ...
                    openCameraSDKPhotoPick(NewAddActivity.this, list);
                }
                else{
                    openCameraSDKImagePreview(NewAddActivity.this,pic_list.get(position).getSource_image(),position);
                }
            }
        });
    }
