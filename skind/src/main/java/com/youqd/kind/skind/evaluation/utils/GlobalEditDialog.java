 ...
 */
public class GlobalEditDialog extends Dialog {
    ...
    public GlobalEditDialog(Context context) {
    ...
    /** 设置左边按钮文字 */
    public GlobalEditDialog setLeftBtnText(String str) {
        left.setText(str);
        return this;
    }

    /** 设置中间按钮文字 */
    public GlobalEditDialog setMiddleBtnText(String str) {
        middle.setText(str);
        return this;
    }

    /** 设置右边按钮文字 */
    public GlobalEditDialog setRightBtnText(String str) {
        right.setText(str);
        return this;
    }

    /** 设置标题文字 */
    public GlobalEditDialog setTitle(String str) {
        title.setText(str);
        return this;
    }

    /** 设置内容文字 */
    public GlobalEditDialog setContent(String str) {
        content.setText(str);
        return this;
    }

    /** 显示标题 */
    public GlobalEditDialog showTitle() {
        showViews(title);
        return this;
    }

    /** 显示内容 */
    public GlobalEditDialog showContent() {
        showViews(content);
        return this;
    }

    /** 显示内容图标 */
    public GlobalEditDialog showIcon() {
        showViews(icon);
        return this;
    }

    /** 显示左边按钮 */
    public GlobalEditDialog showLeft() {
        showViews(left);
        return this;
    }

    /** 显示中间按钮 */
    public GlobalEditDialog showMiddle() {
        showViews(middle);
        return this;
    }

    /** 显示右边按钮 */
    public GlobalEditDialog showRight() {
        showViews(right);
        return this;
    }

    /** 隐藏标题 */
    public GlobalEditDialog hideTitle() {
        hideViews(title);
        return this;
    }

    /** 隐藏内容 */
    public GlobalEditDialog hideContent() {
        hideViews(content);
        return this;
    }

    /** 隐藏内容图标 */
    public GlobalEditDialog hideIcon() {
        hideViews(icon);
        return this;
    }

    /** 隐藏左边按钮 */
    public GlobalEditDialog hideLeft() {
        hideViews(left);
        return this;
    }

    /** 隐藏右边按钮 */
    public GlobalEditDialog hideRight() {
        hideViews(right);
        return this;
    }

    /** 隐藏中间按钮 */
    public GlobalEditDialog hideMiddle() {
        hideViews(middle);
        return this;
    }
    ...
    /** 设置左边按钮监听 */
    public GlobalEditDialog setLeftOnclick(View.OnClickListener listener) {
        left.setOnClickListener(listener);
        return this;
    }

    /** 设置右边按钮监听 */
    public GlobalEditDialog setRightOnclick(View.OnClickListener listener) {
        right.setOnClickListener(listener);
        return this;
    }

    /** 设置中间按钮监听 */
    public GlobalEditDialog setMiddleOnclick(View.OnClickListener listener) {
