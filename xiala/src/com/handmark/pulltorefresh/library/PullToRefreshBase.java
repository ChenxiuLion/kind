...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	public final boolean onTouchEvent(MotionEvent event) {
		...
		switch (event.getAction()) {
			...
			case MotionEvent.ACTION_DOWN: {
				...
				if(mOnMyUpListener != null)
				{
					mOnMyUpListener.down();
				}
				break;
			}
	...
	private OnMyUpListener mOnMyUpListener;
	public final void setOnMyUpListener( OnMyUpListener onMyUpListener)
	{
		mOnMyUpListener = onMyUpListener;
	}
	public interface OnMyUpListener
	{
		public void down();
		public void up();
	}
